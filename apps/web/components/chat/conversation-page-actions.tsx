...
export function ConversationPageActions({
  ...
  return (
    <>
      <div className="relative flex flex-nowrap items-center justify-end gap-1 min-[720px]:gap-1.5">
        <Popover
          open={isMenuOpen}
        ...
        >
          ...
          <PopoverContent
            ...
            className="animate-soft-enter z-20 w-[min(300px,calc(100vw-24px))] overflow-hidden"
          >
            {/* Header */}
              <div className="px-3 pb-1 pt-2.5">
                <p className="text-[11px] font-semibold uppercase tracking-[0.14em] text-app-accent">当前会话</p>
              <h2 className="mt-0.5 truncate text-[14px] font-semibold leading-snug text-app-text">
                {conversationTitle}
              </h2>
            </div>
            ...
            {/* Meta rows */}
            <dl className="grid gap-0.5 px-3 py-0.5">
            ...
            <div className="pb-0.5 pt-0.5">
              ...
              >
                ...
                <span className="min-w-0 flex-1 truncate text-[13px] font-medium">删除会话</span>
              </button>
              {status ? <p className="px-3 pb-1 text-[13px] leading-5 text-red-600">{status}</p> : null}
            </div>
          </PopoverContent>
        </Popover>
