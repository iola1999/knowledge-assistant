...
export const ASSISTANT_TOOL = {
  SEARCH_CONVERSATION_ATTACHMENTS: "search_conversation_attachments",
...
export const ASSISTANT_MCP_TOOL = {
  SEARCH_CONVERSATION_ATTACHMENTS: `${ASSISTANT_MCP_TOOL_PREFIX}${ASSISTANT_TOOL.SEARCH_CONVERSATION_ATTACHMENTS}`,
